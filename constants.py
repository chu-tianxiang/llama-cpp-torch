# Modifed from https://github.com/ggerganov/llama.cpp/blob/master/gguf-py/gguf/constants.py
# The official constants.py lacks support for newly added quants as of 2024/03
# So I copied it with some modifications
